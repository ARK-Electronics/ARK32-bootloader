...
// CAN termination pin on PB7, active high. PB7 -> AN of the ISOM8610 (U2), a
// normally-open opto-emulator switch across the 120R between CAN_H/CAN_L: PB7
// high drives forward current AN->CAT, closing the switch (termination on).
